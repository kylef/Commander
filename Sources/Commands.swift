...
public func command<A:ArgumentConvertible>(_ closure:(A) throws-> ()) -> CommandType {
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible>(_ closure:(A, A1) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible>(_ closure:(A, A1, A2) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible>(_ closure:(A, A1, A2, A3) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5, A6) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5, A6, A7) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5, A6, A7, A8) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible, A10:ArgumentConvertible, A11:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible, A10:ArgumentConvertible, A11:ArgumentConvertible, A12:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible, A10:ArgumentConvertible, A11:ArgumentConvertible, A12:ArgumentConvertible, A13:ArgumentConvertible>(_ closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13) throws-> ()) -> CommandType {
  return AnonymousCommand { parser in
...
public func command<A:ArgumentDescriptor>(_ descriptor:A, closure:(A.ValueType) throws -> ()) -> CommandType {
  return AnonymousCommand { parser in
    let help = Help([
...
public func command<A:ArgumentDescriptor, A1:ArgumentDescriptor>(_ descriptor:A, _ descriptor1:A1, closure:(A.ValueType, A1.ValueType) throws -> ()) -> CommandType {
  return AnonymousCommand { parser in
    let help = Help([
        BoxedArgumentDescriptor(value: descriptor),
...
public func command<A:ArgumentDescriptor, A1:ArgumentDescriptor, A2:ArgumentDescriptor>(_ descriptor:A, _ descriptor1:A1, _ descriptor2:A2, closure:(A.ValueType, A1.ValueType, A2.ValueType) throws -> ()) -> CommandType {
  return AnonymousCommand { parser in
    let help = Help([
        BoxedArgumentDescriptor(value: descriptor),
        BoxedArgumentDescriptor(value: descriptor1),
...
public func command<A:ArgumentDescriptor, A1:ArgumentDescriptor, A2:ArgumentDescriptor, A3:ArgumentDescriptor>(_ descriptor:A, _ descriptor1:A1, _ descriptor2:A2, _ descriptor3:A3, closure:(A.ValueType, A1.ValueType, A2.ValueType, A3.ValueType) throws -> ()) -> CommandType {
  return AnonymousCommand { parser in
    let help = Help([
        BoxedArgumentDescriptor(value: descriptor),
        BoxedArgumentDescriptor(value: descriptor1),
...
extension Group {
  ...
  public func command(_ name:String, description:String? = nil, closure:() throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 1 arguments using a closure
  public func command<A:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 2 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 3 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 4 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 5 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 6 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 7 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 8 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6, A7) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 9 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6, A7, A8) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 10 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 11 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible, A10:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 12 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible, A10:ArgumentConvertible, A11:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 13 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible, A10:ArgumentConvertible, A11:ArgumentConvertible, A12:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }

  /// Add a command which takes 14 arguments using a closure
  public func command<A:ArgumentConvertible, A1:ArgumentConvertible, A2:ArgumentConvertible, A3:ArgumentConvertible, A4:ArgumentConvertible, A5:ArgumentConvertible, A6:ArgumentConvertible, A7:ArgumentConvertible, A8:ArgumentConvertible, A9:ArgumentConvertible, A10:ArgumentConvertible, A11:ArgumentConvertible, A12:ArgumentConvertible, A13:ArgumentConvertible>(_ name:String, description: String? = nil, closure:(A, A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13) throws -> ()) {
    addCommand(name, description, Commander.command(closure))
  }
  ...
  /// Add a command which takes 1 arguments using a closure
  public func command<A:ArgumentDescriptor>(_ name: String, _ descriptor: A, description: String? = nil, closure: (A.ValueType) throws -> ()) {
    addCommand(name, description, Commander.command(descriptor, closure: closure))
  }

  /// Add a command which takes 2 arguments using a closure
  public func command<A:ArgumentDescriptor, A1:ArgumentDescriptor>(_ name: String, _ descriptor: A, _ descriptor1: A1, description: String? = nil, closure: (A.ValueType, A1.ValueType) throws -> ()) {
    addCommand(name, description, Commander.command(descriptor, descriptor1,  closure: closure))
  }

  /// Add a command which takes 3 arguments using a closure
  public func command<A:ArgumentDescriptor, A1:ArgumentDescriptor, A2:ArgumentDescriptor>(_ name: String, _ descriptor: A, _ descriptor1: A1, _ descriptor2: A2, description: String? = nil, closure: (A.ValueType, A1.ValueType, A2.ValueType) throws -> ()) {
    addCommand(name, description, Commander.command(descriptor, descriptor1,  descriptor2,  closure: closure))
  }

  /// Add a command which takes 4 arguments using a closure
  public func command<A:ArgumentDescriptor, A1:ArgumentDescriptor, A2:ArgumentDescriptor, A3:ArgumentDescriptor>(_ name: String, _ descriptor: A, _ descriptor1: A1, _ descriptor2: A2, _ descriptor3: A3, description: String? = nil, closure: (A.ValueType, A1.ValueType, A2.ValueType, A3.ValueType) throws -> ()) {
